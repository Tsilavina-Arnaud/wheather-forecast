        ...
        <div class="block text-center">
            <el-carousel height="450px">
                ...
                >
                    ...
                    <h2 class="font-semibold absolute bottom-0 mb-3 left-2">
                        {{ item.name }}
                    </h2>
                </el-carousel-item>
            </el-carousel>
...
import MenClothes from '../../bdd/womanClothes'
...
const clothes = computed(() => {
    ...
    if (temp_c >= -5 && temp_c <= 0) {
        return MenClothes[1]
    }
    if (temp_c >= 0 && temp_c <= 10) {
        return MenClothes[2]
    }
    if (temp_c >= 10 && temp_c <= 15) {
        return MenClothes[3]
    }
    if (temp_c >= 15 && temp_c <= 20) {
        return MenClothes[4]
    }
